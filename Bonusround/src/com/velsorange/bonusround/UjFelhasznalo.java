...
public class UjFelhasznalo extends Activity {
	...
	public void attemptLogin() {
		...
		if (TextUtils.isEmpty(mPassword)) {
			...
			mPasswordView2
					.setError(getString(R.string.error_jelszo_nem_egyezik));
			focusView = mPasswordView2;
			cancel = true;
		}
		Toast.makeText(getApplicationContext(), "p1:" + mPassword + " p2:"
				+ mPassword2, Toast.LENGTH_LONG);
		...
		if (cancel) {
			...
			showProgress(true);
			// annak a felhasználónak idje kell aki létrehozza az új
			// felhasználót!!!!!!!!!!!!!
			int i = 1;
			if (nincsfelhasznalo) {
				i = 1;
			...
			if (UserCreate(nincsfelhasznalo.toString(), i)) {
				Toast.makeText(getApplicationContext(),
						"Létrejött a(z) " + mEmail + " nevû felhasználó!",
